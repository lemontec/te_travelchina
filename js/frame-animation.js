(function (root, factory) {
    ...
    frame_ani.prototype.setPoster = function() {
		...
		this.ctx.drawImage(this.frames[0],
             this.showX, this.showY, this.canvasWidth,this.canvasHeight,
             0, 0, this.canvasWidth, this.canvasHeight
        );
    ...
    frame_ani.prototype.calculate = function() {
		...
		//改变剪裁的算法，默认横向全显示，纵向靠上显示
		/*                 0, 0, /this.sourceWidth/750, this.sourceHeight,
                 0, 0, this.canvasWidth, /this.canvasHeight/1437 */
		//console.log("cR:" + canvasR + "iR:" + imageR);
		
		this.showX = 0;
        this.showY = 0;
		this.sourceWidth = this.option.width;
		this.sourceHeight = this.option.height;
		var canvasRate = 1.0 * this.sourceWidth / this.sourceHeight;
		this.canvasHeight = this.canvasWidth / canvasRate;
